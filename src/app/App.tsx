    ...
    <div className={`min-h-[100dvh] min-h-screen overflow-x-clip transition-colors duration-700 ${isDark ? "bg-[#0a0a0a]" : "bg-white"}`}>
      ...
      <style>{`
        ...
        @media (min-width: 1024px) {
          [data-name="Main V2"] > [data-route="index"] > div:first-child > div {
          ...
          [data-name="Main V2"] > [data-route="index"] > div:first-child {
        ...
        /* Right content area */
        [data-name="Main V2"] > [data-route="index"] > div:nth-child(2) {
          height: auto !important;
          flex: 1 !important;
        ...
        [data-name="Main V2"] > [data-route="playground"] {
        ...
        [data-name="Main V2"] > div:last-child {
