...
/** Glass pill link — secondary navigation actions. */
export function SiteGhostLink({
  ...
  return (
    <Link
      to={to}
      className={`relative flex h-[44px] min-h-[44px] w-fit shrink-0 cursor-pointer items-center justify-center gap-[2px] rounded-[1000px] border-0 px-[10px] py-[4px] no-underline transition-all duration-200 hover:scale-105 ${isDark ? "text-white" : "text-[#0a0c11]"} ${className}`}
      data-name="Button"
    >
      <span
        aria-hidden
